...
<div class="relative z-[1001]" x-data="{
    dropdownOpen: false,
    notifying: true,
    toggleDropdown() {
    ...
    <div x-show="dropdownOpen" x-transition:enter="transition ease-out duration-100"
        ...
        class="absolute -right-[240px] mt-[17px] flex h-[480px] w-[350px] flex-col rounded-2xl border border-gray-200 bg-white p-3 shadow-theme-lg dark:border-gray-800 dark:bg-gray-dark sm:w-[361px] lg:right-0 z-[1001]"
        style="display: none;">
        <!-- Dropdown Header -->
