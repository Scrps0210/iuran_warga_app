        ...
        <nav x-data="{ selected: $persist('Dashboard') }">
            ...
            <div>
                ...
                <ul class="flex flex-col gap-4 mb-6">
                    ...
                    <li>
                        <a href="{{ route('warga.index') }}" @click="selected = 'DataWarga'" class="menu-item group"
                            :class="(selected === 'DataWarga' || page.startsWith('warga')) ? 'menu-item-active' : 'menu-item-inactive'">
                            <svg :class="(selected === 'DataWarga' || page.startsWith('warga')) ? 'menu-item-icon-active' : 'menu-item-icon-inactive'"
                                width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd"
                    ...
                    <!-- Menu Item Data Iuran -->
                    <li>
                        <a href="{{ route('iuran.index') }}" @click="selected = 'DataIuran'" class="menu-item group"
                            :class="(selected === 'DataIuran' || page.startsWith('iuran')) ? 'menu-item-active' : 'menu-item-inactive'">
                            <svg :class="(selected === 'DataIuran' || page.startsWith('iuran')) ? 'menu-item-icon-active' : 'menu-item-icon-inactive'"
                                width="24" height="24" viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" clip-rule="evenodd"
            ...
            <div :class="sidebarToggle ? 'lg:hidden' : ''"
                ...
                <p class="mb-4 text-gray-500 text-sm dark:text-gray-400">
                    Sistem Pengelolaan Iuran Warga Digital.
                </p>
            </div>
        </nav>
    </div>
