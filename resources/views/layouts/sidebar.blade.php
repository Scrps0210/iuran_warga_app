...
<aside id="sidebar"
    class="fixed flex flex-col mt-0 top-0 px-5 left-0 bg-white dark:bg-gray-900 dark:border-gray-800 h-screen transition-all duration-300 ease-in-out z-[9999] border-r border-gray-200"
    x-cloak x-data="{
        openSubmenus: {},
        ...
        'w-[290px] translate-x-0': $store.sidebar.isExpanded || $store.sidebar.isMobileOpen || $store.sidebar.isHovered,
        'w-[90px] translate-x-0': !$store.sidebar.isExpanded && !$store.sidebar.isHovered && window.innerWidth >= 1024,
