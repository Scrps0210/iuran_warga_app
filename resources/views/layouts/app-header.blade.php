<header
    class="sticky top-0 relative z-[1000] flex w-full bg-white border-gray-200 dark:border-gray-800 dark:bg-gray-900 lg:border-b transition-all duration-300 ease-in-out"
    :class="{
        'lg:ml-[290px] w-auto': $store.sidebar.isExpanded || $store.sidebar.isHovered,
        'lg:ml-[90px] w-auto': !$store.sidebar.isExpanded && !$store.sidebar.isHovered,
    ...
    <div class="max-w-7xl mx-auto w-full flex flex-col items-center justify-between grow lg:flex-row lg:px-6">
        <div
            class="flex items-center justify-between lg:w-auto w-full gap-2 px-3 py-3 border-b border-gray-200 dark:border-gray-800 sm:gap-4 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-4">
        ...
        <div class="hidden lg:flex flex-1 justify-center max-w-xl mx-auto px-4">
        ...
        <div :class="isApplicationMenuOpen ? 'flex' : 'hidden'"
            class="items-center justify-between lg:w-auto w-full gap-4 px-5 py-4 lg:flex shadow-theme-md lg:justify-end lg:px-0 lg:shadow-none">
